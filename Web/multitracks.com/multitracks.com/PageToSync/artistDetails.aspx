...
<head>
	...
	<body class="premium standard u-fix-fancybox-iframe">
		<form>
			...
			<div class="wrapper mod-standard mod-gray">
				<uc:Banner runat="server" Id="banner"/>
				
				<!-- TODO: Turn button navigation into user-control for readability and modularity -->
										...
										<li class="song-list--item media-player--row">
											...
											<div class="song-list--item--player-img media-player">
												<img class="song-list--item--player-img--img"
                                                     src="<%#Eval("Album.ImageURL") %>" alt="<%#Eval("Title") %>">
											</div>

											<div class="song-list--item--right">

												<a href="#" class="song-list--item--primary"><%#Eval("Title") %></a>
												<a class="song-list--item--secondary"><%#Eval("Album.Title") %></a>
												<a class="song-list--item--secondary"><%#Eval("Bpm") %> BPM</a>
												<a class="song-list--item--secondary"><%#Eval("TimeSignatureObject") %></a>
			...
			<!--ATTENTION: #include virtual = "../includes/footer.aspx" -->
    ...
    <script type="text/javascript">
		let biographyExtendedParagraph = document.querySelector("#biographyExtendedParagraph");
        let readMoreLink = document.querySelector("#readMoreLink");
		biographyExtendedParagraph.style.display = "none";
        readMoreLink.addEventListener("click",
            evt => {
				evt.preventDefault();
				if (biographyExtendedParagraph.style.display === "none") {
					biographyExtendedParagraph.style.display = "block";
